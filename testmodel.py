...
colors = [(245,117,16), (117,245,16), (16,117,245), (245,117,16), (117,245,16), (117,245,255)]
...
def extract_keypoints(results):
    ...
    return np.concatenate([lh, rh]) #tilføj hvad du har brugt
...
model.add(LSTM(64, return_sequences=True, activation='relu', input_shape=(DESIRED_LENGTH, 126))) #desired frames, input
...
model.load_weights('1665662204.699193_action.h5')
